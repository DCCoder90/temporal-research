...
import (
	...
	"os"
	"strings"
	"temporal-lens/internal/analysis"
	"temporal-lens/internal/config"
	"temporal-lens/internal/filter"
...
Examples:
  temporal-lens capture.pcap
  temporal-lens capture.pcap --only grpc
  temporal-lens capture.pcap --only grpc,http
  temporal-lens capture.pcap --exclude pgsql,tcp
  ...
  temporal-lens capture.pcap --no-interservice
  temporal-lens capture.pcap --no-interservice --only grpc`
